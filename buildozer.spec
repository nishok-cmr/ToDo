...
# 2) A directory, here  'legal_resource_name' directory will be created and contents will be copied
#    into that directory.
# android.add_resources = legal_resource_name:path/to/directory1,legal_resource_name2:path/to/directory2
# 3) A directory, here contents will be copied to the root of the res directory.
